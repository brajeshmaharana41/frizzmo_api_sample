...
const MyAccountDetail: AccountData[] = [
  ...
  { icon: 'mail_outline', title: 'Refer a Teacher', inv_btn: 'account-btn',  subtitle: '20% off for you and 20% off for your colleagues', inv_title: 'Refer Now', account_rout: '/refer'},
]
@Component({
